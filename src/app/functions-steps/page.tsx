...
const Stepper = dynamicImport(() => import("react-form-stepper").then((mod) => mod.Stepper), {
    ssr: false,
});
const Step = dynamicImport(() => import("react-form-stepper").then((mod) => mod.Step), {
    ssr: false,
});
...
function FunctionsStepsWrapper() {
    const searchParams = useSearchParams();
...
export default FunctionsStepsWrapper;
